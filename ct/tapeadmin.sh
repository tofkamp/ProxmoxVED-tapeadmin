...
source "$_cs_boot" 2>/dev/null || source <(curl -fsSL "${COMMUNITY_SCRIPTS_CORE_URL:-https://raw.githubusercontent.com/tofkamp/ProxmoxVED-tapeadmin/refs/heads/feat/tapeadmin}/core/build.func")
